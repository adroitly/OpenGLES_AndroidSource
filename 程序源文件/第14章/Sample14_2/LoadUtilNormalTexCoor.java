...
public class LoadUtilNormalTexCoor 
{
	//求两个向量的叉积
    ...
    public static void  loadFromFileVertexTexCoor(String fname)
    {
    	...
    	try
    	{
		    ...
		    //输出顶点法向量信息
		    sb.append("var vertexDataNormalFromObj=[\n");		    
		    size=nXYZ.length;		    
		    for(int i=0;i<size;i++)
		    {
		    	sb.append(nXYZ[i]);		    	
		    ...
		    //输出顶点纹理坐标信息
		    sb.append("var vertexTexCoorFromObj=[\n");		    
		    size=tST.length;		    
		    for(int i=0;i<size;i++)
		    {
		    	sb.append(tST[i]);		    	
